...
public abstract class PropertyLoader {
    ...
    static final Logger LOGGER = Logger.getLogger(PropertyLoader.class.getName());
    ...
    public static Properties loadProperties(String name, ClassLoader loader) {
        if (name == null) {
            LOGGER.log(Level.SEVERE, "Service property file name was null!");
            return null;
        }
        ...
        try {
            ...
            LOGGER.log(Level.SEVERE, "Unable to load service properties!");
     ...
     * that uses the current threads context class loader.
     */
